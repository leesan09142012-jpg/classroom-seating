// 공통 SVG 아이콘 — stroke 기반, currentColor 사용
const s = { className: 'w-4 h-4 inline-block', fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor', strokeWidth: 2 };

export function IconSchool(props) {
  return (
    <svg {...s} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 14l9-5-9-5-9 5 9 5z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 14l6.16-3.422A12.083 12.083 0 0121 12.75c0 3.314-4.03 6-9 6s-9-2.686-9-6c0-.84.27-1.637.752-2.353L12 14z" />
